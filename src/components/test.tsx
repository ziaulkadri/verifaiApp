...
import { cropImage, damageDetection, generateUUID } from '../utils/utils';
...
const ProcesssingScreen = ({navigation}) => {
  ...
  const cropImage = () => {
    console.log("cropping image",imageSource)
    const ymin = 454 , xmin = 319, ymax =1147, xmax = 1156;
...
// }
    ...
    const response = {
      "Trunk": {
          ...
          "damage_info": [
              "Old damage of dent detected on panel name trunk at Trunk view of car",
              "Old damage of dent detected on panel name trunk at Trunk view of car",
              "Old damage of dent detected on panel name trunk at Trunk view of car",
              "Old damage of dent detected on panel name trunk at Trunk view of car"
          ],
  ...
  return (
    <View style={styles.container}>
      ...
      {/* <MarkedImage croppedHeight={response.Trunk.img_resolution[0]} croppedWidth={response.Trunk.img_resolution[1]}  coordinates={response.Trunk.panel_polygon[0].polygon}/> */}

      { croppedImageUri ?<Image
